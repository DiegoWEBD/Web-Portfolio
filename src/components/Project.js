const Project = ({ project }) => {
    ...
    return(
        <div className='w-[440px] flex justify-center'>
            <div className="w-[350px] hover:w-[368px] sm:w-[400px] sm:hover:w-[418px] block pt-6 pb-4 mb-12 px-[26px] hover:px-[35px] h-fit transition-all  rounded-lg shadow-lg shadow-black/60 bg-neutral-300 hover:shadow-xl hover:shadow-black/60 hover:rounded-xl">
                ...
                <div className="mt-4 break-words">
                    <p className="mb-1 text-2xl text-indigo-700 font-extrabold transition-all duration-300">{ project.name }</p>
                    <p className="mb-4 text-[15px] text-slate-900 font-semibold italic transition-all duration-300">{ project.description }</p>
                    ...
                    }
                    {
                        project.page_link
                            ?   <div className="mb-1 flex">
                                    <p className="text-xs text-indigo-700 font-bold mr-3 transition-all duration-300">Web:</p>
